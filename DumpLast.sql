...
CREATE TABLE `accounts` (
  ...
  CONSTRAINT `accountID` FOREIGN KEY (`ownerID`) REFERENCES `clients` (`idClient`)
...
INSERT INTO `accounts` VALUES (1,1223242,1,0,101),(2,223424,3,0,1000),(3,54321,5,0,11000),(4,12345,4,0,2154),(5,425,1,1,12544),(6,4772,1,0,10),(7,1258,3,0,666),(8,145257,2,0,452),(9,123456789,6,1,0);
...
INSERT INTO `clientlogindata` VALUES (1,'Fir','123'),(2,'Sec','1234'),(3,'Thi','qwe'),(4,'Four','qwe123'),(5,'Fiv','123'),(6,'Six','123');
...
INSERT INTO `clients` VALUES (1,'Ada','RacoonCity','JA128975B','22.03.1996'),(2,'Trish','RedGrave','NA23424M','17.10.2001'),(3,'Zelda','Hyrule','KL232248I','21.02.1986'),(4,'Raiden','New York','LA434500Y','13.07.1987'),(5,'Gordon','City17','MA343118O','19.11.1998'),(6,'Shepard','Space','JS239901L','20.11.2007');
...
INSERT INTO `payments` VALUES (1,100,1,1),(2,11,2,1),(3,1,3,2),(4,111,1,2),(5,1,7,2),(6,1,1,2);
...
-- Dump completed on 2019-08-28 15:02:05
